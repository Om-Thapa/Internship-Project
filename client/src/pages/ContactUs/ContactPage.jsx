...
export default function ContactPage() {
  return (
    <section className="bg-[#F8FCF8] min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600 text-xl mt-6 max-w-3xl mx-auto">
            Whether you have questions about our products, want to become
            a distributor, or simply wish to learn more about respiratory
